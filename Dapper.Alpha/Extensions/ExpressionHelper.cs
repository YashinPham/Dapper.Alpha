        ...
        public static MemberExpression GetMemberExpression(Expression expression)
        {
            switch (expression)
            {
                case MethodCallExpression expr:
                    ...
                    else if (expr.Arguments[0] is MemberExpression)
                        return (MemberExpression)expr.Arguments[0];
                    else if (expr.Arguments[0] is UnaryExpression biLeft)
                        return (MemberExpression)biLeft.Operand;
                    else
                        return (MemberExpression)((BinaryExpression)expr.Arguments[0]).Left;
                case MemberExpression memberExpression:
